...
=item Move guts of PackageImporter into Repos class.

=item Attach logger to Repos object.  Delegate methods.

=item Capture username in log messages.

=item Decide if there should be an init stack or not.
