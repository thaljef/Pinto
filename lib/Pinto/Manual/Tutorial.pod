...
at .pinto/config/pinto.ini.  This file is generated for you with default 
values when you create the repository.  You will likely never need to touch 
this file.  If you do, `perldoc bin/pinto` will provide guidance.  
